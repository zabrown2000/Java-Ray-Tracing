...
public class RayTracerSuperSampling extends RayTraceBase {
	...
	public primitives.Color traceRay(Ray ray) {
		...
		//maybe make this wrapper function for new traceRay?
	...
	//for below functions, figure out how will use each one and make modifications
	...
	private List<Ray> shootMultipleRefractoredRays(Ray ray) {
		Ray relective = constructRefractedRay(ray);
