...
class PlaneTests {
	...
	void testFindIntersection() {
		...
		assertEquals(p1, plane1.findIntsersections(ray1).get(0), "Ray does not interset the plane");
		...
		assertEquals(p3, plane3.findIntsersections(ray3).get(0), "Ray does not interset the plane");
		...
		assertEquals(p5, plane3.findIntsersections(ray5).get(0), "Ray orthogonal to the plane before the plane");
		
		//TC14: orthogonal to the plane in the plan
		//ray starts on the plane 
		assertEquals(p5, plane3.findIntsersections(ray5).get(0), "Ray orthogonal to the plane in the plane");
		...
		assertEquals(p8, plane3.findIntsersections(ray8).get(0), "Ray start on the plane");
