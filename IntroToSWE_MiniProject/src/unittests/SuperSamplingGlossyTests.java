...
class SuperSamplingGlossyTests {
	...
	void glossyAndDiffuseTest() {
		...
		scene.geometries.add( //
				...
				new Sphere(new Point(-550, -500, -1200), 200d).setEmission(new Color(242, 219, 222)) //pink sphere
						.setMaterial(new Material().setKD(0.6)),
				new Sphere(new Point(-1300,-100,-300), 200d).setEmission(new Color(204,240,255)) //green sphere, further away
						.setMaterial(new Material().setKD(0.6)),
