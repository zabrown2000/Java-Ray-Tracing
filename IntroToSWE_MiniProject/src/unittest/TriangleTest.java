...
class TriangleTest {
	...
	void testFindIntersection() {
		...
		assertEquals(null, t1.findIntersections(r1), "ERROR: Not intersect inside the triangle ");
		...
		assertEquals(null, t1.findIntersections(r6), "ERROR: Not intersect inside the triangle ");
		
		
		//TC03: inside a triangle
		Point p6 = new Point(2,0.5,0);
		Ray r5 = new Ray(new Point(1.53,0.53,2), new Vector(0.47,-0.03,-2));
		assertEquals(p6, t1.findIntersections(r5).get(0), "ERROR: Not intersect inside the triangle ");
		...
		assertEquals(p7, t1.findIntersections(r2).get(0), "ERROR: Not intersect side of triangle");
		
		//TC12: On the corner of a triangle
		Ray r3 = new Ray(new Point(1.53,0.53,2), new Vector(0.47,0.47,-2));
		assertEquals(p3, t1.findIntersections(r3).get(0), "ERROR: Not intersect corner of triangle");
		...
		assertEquals(null, t1.findIntersections(r4), "ERROR: Not intersect line of triangle");
