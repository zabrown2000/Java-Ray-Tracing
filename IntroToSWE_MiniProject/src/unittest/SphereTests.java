...
class SphereTests {
    ...
    public void testFindIntersections() {
        ...
        assertEquals(new Point(1,0,1), sphere.findIntersections(new Ray(new Point(1, 0, 0),new Vector(1, 0, 1))),"ray starts inside the sphere"); 
       
        // TC04: Ray starts after the sphere (0 points)
        assertNull(sphere.findIntersections(new Ray (new Point(6,6,6), new Vector(7,7,7))), "ray starts after the sphere");
        ...
        assertEquals(new Point(1,0,1), sphere.findIntersections(new Ray(new Point (2,0,0), new Vector(1,0,1))), "Ray starts at sphere and goes inside");
        
        // TC12: Ray starts at sphere and goes outside (0 points)
        assertNull(sphere.findIntersections(new Ray(new Point(2,0,0), new Vector(2,0,1) )),"Ray starts at sphere and goes outside"); //double check might not work
        ...
        assertNull(sphere.findIntersection(new Ray(new Point(1,1,0), new Vector(0,1,0) )), "Ray starts at sphere and goes outside");
        
        // TC18: Ray starts after sphere (0 points)
        assertNull(sphere.findIntersections(new Ray(new Point(2,5,0), new Vector(1,5,0)))," Ray starts at sphere and goes outside");
