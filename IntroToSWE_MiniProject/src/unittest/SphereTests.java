...
class SphereTests {
    ...
    public void testFindIntersections() {
		...
		result3.add(new Point(1.4114378277661475,0.0,0.9114378277661476));
		assertEquals(result3, sphere.findIntsersections(new Ray(new Point(0.5, 0, 0),new Vector(1, 0, 1))),"ray starts inside the sphere"); 
